...
picked_fruits = streamlit.multiselect("Pick your fruits for your smoothie!", list(my_fruit_list.index),['Avocado','Strawberries'])

#Display the table on the page
streamlit.dataframe(my_fruit_list.picked_fruits)
